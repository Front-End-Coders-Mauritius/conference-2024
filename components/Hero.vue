  ...
  <div class="relative py-20 sm:pb-24 sm:pt-36">
    ...
    <Container class="relative">
      <div class="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
        ...
        >
          <span class="sr-only">frontend & friends - </span>frontend & friends
          conference
        </h1>
        <div
        ...
        >
          <p>
            After more than 50 succesful meetups organized in Mauritius, we are
        ...
        >
          <div v-for="[name, value] in data" :key="name">
